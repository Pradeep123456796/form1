 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3" class="brand-link">
      <img src="{{asset('assets/css/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('assets/css/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="fixed-sidebar-custom" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="userlistdata" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User List</p>
                </a>
              </li>
             <!--  <li class="nav-item">
              ...
              <!-- <li class="nav-item">
                <a href="regration" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Regration User</p>
                </a>
              </li> -->
