  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Regration User</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Regration User</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Quick Regration <small>User Regration</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="regration" >
                @if(session()->get('msg')){{
                session()->get('msg')
              }}
              ...
              @endif
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="usermobileno" class="form-control"  placeholder="Enter User Mobile">
                  </div>
                  <div class="form-group">
