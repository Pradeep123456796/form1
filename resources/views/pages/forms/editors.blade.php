...
<head>
  ...
  <!-- CodeMirror -->
  <link rel="stylesheet" href="{{ asset('assets/js/plugins/codemirror/codemirror.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/js/plugins/codemirror/theme/monokai.css') }}">
  <!-- SimpleMDE -->
...
<script src="{{ asset('assets/js/plugins/codemirror/mode/css/css.js') }}"></script>
<script src="{{ asset('assets/js/plugins/codemirror/mode/xml/xml.js') }}"></script>
<script src="{{ asset('assets/js/plugins/codemirror/mode/htmlmixed/htmlmixed.js') }}"></script>
