...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/js/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('assets/js/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
  <!-- Bootstrap4 Duallistbox -->
  <link rel="stylesheet" href="{{ asset('assets/js/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css') }}">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="{{ asset('assets/js/plugins/bs-stepper/css/bs-stepper.min.css') }}">
  <!-- dropzonejs -->
...
<!-- Bootstrap4 Duallistbox -->
<script src="{{ asset('assets/js/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js') }}"></script>
<!-- InputMask -->
...
<!-- Bootstrap Switch -->
<script src="{{ asset('assets/js/plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}"></script>
<!-- BS-Stepper -->
<script src="{{ asset('assets/js/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>
<!-- dropzonejs -->
