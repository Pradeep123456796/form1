...
<head>
  ...
  <!-- bootstrap slider -->
  <link rel="stylesheet" href=".{{ asset('assets/js/plugins/bootstrap-slider/css/bootstrap-slider.min.css') }}">
  <!-- Theme style -->
...
<!-- Bootstrap slider -->
<script src="{{ asset('assets/js/plugins/bootstrap-slider/bootstrap-slider.min.js') }}"></script>
