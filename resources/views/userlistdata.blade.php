...
<div class="wrapper">
  ...
  <div class="content-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table  class="table table-bordered table-striped">
                  <thead>
                    <form method="get" action="userlistdata" >
    ...
    <tr><td>{{$list_value['id']}}</td><td>{{$list_value['name']}}</td><td>{{$list_value['email']}}</td>
      <td><a href={{"editlistdata/".$list_value['id']}} >Edit</a></td><td><a href={{"deletedata/".$list_value['id']}} >Delete</a></td></tr>
    @endforeach
                  </tbody>
                  <tfoot>
                 <!--  <tr>
